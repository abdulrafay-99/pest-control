...
function About() {
  return (
    <section>
      <div className="w-full h-[50vh] bg-about px-12 flex items-center justify-center">
          <div className="text-slate-950 tracking-widest leading-loose text-lg bg-white border-2 border-black p-4">
          <h1 className="text-4xl text-center underline ">Our Mission</h1>
          <p className="text-center font-mono font-extrabold">To provide affordable, efficient and quick pest control services to our customers.</p>
    </div>
